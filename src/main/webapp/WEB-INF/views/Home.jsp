	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item dropdown"><a
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					<a class="dropdown-item" href="addexpense">Add Expense</a> <a
						class="dropdown-item" href="listexpense">List Expenses</a>
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					<a class="dropdown-item" href="addaccount">Add Account</a> <a
						class="dropdown-item" href="listaccount">List Accounts</a>
			...
			<li class="nav-item"><a class="nav-link" href="logout">Logout</a></li>
						<li class="nav-item"><a class="nav-link" href="UpdateUserFormController?userId=${userId}">Update Profile</a></li>
